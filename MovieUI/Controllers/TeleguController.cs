...
namespace MovieUI.Controllers
{
    ...
    public class TeleguController : Controller
    {
        ...
        {
            return View(Movielibrarian.GetAllMoviesByRentalType(TypesOfRental.Rent,TypeOfLanguages.Telegu));
        }
        ...
        {
            return View(Movielibrarian.GetAllMoviesByRentalType(TypesOfRental.Buy, TypeOfLanguages.Telegu));
        }
    }
}
